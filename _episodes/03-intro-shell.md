...
on your computer. If you're using Windows, you'll need to download a separate program to access the shell. Conveniently, 
we will access the shell through the Jupyter webinterface during the workshop.
